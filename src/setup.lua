...
function Setup.cleanUp()
  ...
  -- clean remote 
  Setup.createFolder(global.results, settings:get(global.loadgenWd), setttings:isLocal())
  Setup.createFolder(global.scripts, settings:get(global.loadgenWd), setttings:isLocal())
