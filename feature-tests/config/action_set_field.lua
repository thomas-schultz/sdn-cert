...
feature.new_SRC_MAC = "aa:aa:aa:aa:aa:aa"
feature.new_SRC_IP4 = "10.0.2.1"
--feature.new_SRC_PORT = 4321

feature.flowEntries = function(flowData)
    table.insert(flowData.flows, "priority=1, dl_type=" .. feature.enum.ETH_TYPE.wol .. ", actions=set_field:" .. feature.new_SRC_MAC .. "->dl_src,ALL")
    table.insert(flowData.flows, "priority=2, ip, actions=set_field:" .. feature.new_SRC_IP4 .. "->nw_src,ALL")
...
FeatureConfig.pktClassifier = {
    function(pkt) return (pkt.src_mac == feature.new_SRC_MAC) end,
    function(pkt) return (pkt.src_ip == feature.new_SRC_IP4) end,
    --function(pkt) return (pkt.src_port == feature.new_SRC_PORT) end,
  }
